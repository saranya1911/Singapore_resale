...
data = pd.read_csv('C:\\Users\\psara\\Desktop\\SARANYA_VS\\cap6singapore_resale\\App\\mrt.csv')
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r'C:\\Users\\psara\\Desktop\\SARANYA_VS\\cap6singapore_resale\\App\\model.pkl', 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r'C:\\Users\\psara\\Desktop\\SARANYA_VS\\cap6singapore_resale\\App\\scaler.pkl', 'rb') as f:
                ...
                query_string = 'https://www.onemap.gov.sg/api/common/elastic/search?searchVal=' + str(
                    query_address) + '&returnGeom=Y&getAddrDetails=Y&pageNum=1'
